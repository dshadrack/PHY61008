...
Implicit none
!Define Variables
DoublePrecision :: r(0:6,0:2),v(0:6,0:2),F(0:6,0:2),a(0:6,0:2,-6:1)
...
Integer(8) :: i,j,k,t,done, tmax,length,x, n, Logging
...
read *, Logging
Write(6,*) ""
step = (1/ (maxval(a(:,:,-1)**2))**0.25) * TimeFactor
Write(6,*) Step
